...
#### Dropout Connect
Rather than set some of the neurons to zero,Dropout Connect randonly set some of the parameter to zero,that it drops out some connection between two neuron.
