...
Recall 3 * 3 convolution,stride 2 and pad 1.Traspose Convolution rather than take dot product,take the value of inputs to multiply the convolution core.The overlapping area takes the sum of all the output.
## Localization
