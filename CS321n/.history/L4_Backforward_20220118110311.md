...
## Vectorized Operation
  ...
  it function is an mutinomial function work on vection space,while its gradient is the yaccobi matrix.
    $$ \frac{\partial(y_1,y_2,...y_{4096})}{\partial(x_1,x_2,...x_{4096})} = 
    \begin{bmatrix}
    \frac{\partial y_1}{\partial x_1} & \frac{\partial y_2}{\partial x_2} &\dots & \frac{\partial y_n}{\partial x_1}\\
    & & \ddots & & \vdots\\
    \frac{\partial y_1}{\partial x_{4096}} & & &\frac{\partial y_{4096}}{\partial x_{4096}}
