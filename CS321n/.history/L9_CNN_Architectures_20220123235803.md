...
Sometime use 1 * 1 CONV to reduce depth before a CONV or after a POOL in order to reduce the computational cost.
...
''Res'' means residual that means the F(x).Learning residual is easier then directly learning the 
